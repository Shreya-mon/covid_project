...
<?php 
	$qry = mysqli_query($link, "SELECT * FROM `ngo_registration` WHERE `id` = '".$_REQUEST['id']."'");
...
$qry = mysqli_query($link, "UPDATE `ngo_registration` SET `category`='".$cate."' WHERE `id`='".$_REQUEST['id']."'");
if($new_proof != ''){
...
<div class="container pt-5 pb-5">
        <div class="row pt-3 pb-3 text-center" style="background-color: #c368ff; color: #FFFFFF">
            ...
            <h2 class="col-10">Update Your Record As NGO</h2>
        </div>
