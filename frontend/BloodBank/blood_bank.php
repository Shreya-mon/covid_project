    ...
    <div class="container mt-2 " style="border: 1px solid gray">
      ...
      <div class="row">
        <div class="col-6 text-center pt-2"  >
            <h4>DONATE BLOOD</h4>
            <button type="button" class="btn btn-success btn-block mt-4 mb-2" data-bs-toggle="modal" data-bs-target="#userpanelmodel" >
            Click Here
          </button>
        </div>
        <div class="col-6 text-center pt-2"  >
      ...
      <div class="row mt-3" style="height: 350px; overflow: auto;">
        <table class="table">
