...
<?php 
	$qry = mysqli_query($link, "SELECT * FROM `ngo_help_db` WHERE `id` = '".$_REQUEST['id']."'");
...
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `name`='".$_REQUEST['name']."' WHERE `id`='".$_REQUEST['id']."'");
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `address`='".$_REQUEST['address']."' WHERE `id`='".$_REQUEST['id']."'");
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `district`='".$_REQUEST['district']."' WHERE `id`='".$_REQUEST['id']."'");
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `ph_no`='".$_REQUEST['phno']."' WHERE `id`='".$_REQUEST['id']."'");
$qry1 = mysqli_query($link, "UPDATE `ngo_help_db` SET `file`='".$_REQUEST['proof']."' WHERE `id`='".$_REQUEST['id']."'");
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `description`='".$_REQUEST['description']."' WHERE `id`='".$_REQUEST['id']."'");
$qry = mysqli_query($link, "UPDATE `ngo_help_db` SET `category`='".$_REQUEST['helpingCategoriesOfNGO']."' WHERE `id`='".$_REQUEST['id']."'");
...
<div class="container pt-5 pb-5">
        <div class="row pt-3 pb-3 text-center" style="background-color: #c368ff; color: #FFFFFF">
            ...
            <h2 class="col-10">Update Your Record As Help Seeker</h2>
        </div>
        <div class="row mt-5 center-center p-4">
            <form class="col-12 row p-2" action="#" method="POST" enctype="multipart/form-data"
                ...
                <div class="col-12 mt-1">
                    ...
                    <textarea name="description" rows="5" class="form-control"><?=$row['description']?></textarea>
