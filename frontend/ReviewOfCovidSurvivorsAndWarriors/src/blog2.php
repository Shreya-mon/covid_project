        ...
        <div class="description-container">
            <h1>Never locked up for so many days at my home</h1>
                <div class="banner">
                    ...
                    <h4 class="heading">Testing positive for COVID-19 surprises <br>some while triggers stress in others</h4>
                </div>
           
            <p class="content">
                Getting tested positive for Covid-19 is stressful. It surprises some while triggers stress in others. People share their experience of getting infected and coping with the virus that locks them up in a room, brings bodily changes and affects relationships.<br>
