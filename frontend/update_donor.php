...
<body>
    <div class="container pt-5 pb-5">
        <div class="row pt-3 pb-3 text-center" style="background-color: #c368ff; color: #FFFFFF">
            ...
            <h2 class="col-10">Update Your Record As Donor</h2>
        </div>
        <div class="row mt-5 center-center p-4">
        <form class="col-12 row p-2" action="update_donor_data.php" method="POST"
                ...
                <div class="col-12 mt-1">
                    ...
                    <select class="form-control" name="freq">
                        <option value="Regular donor" <?php if($freq=='Regular donor' ){echo "selected" ;} ?>
                            >Regular donor</option>
                        <option value="On need basis" <?php if($freq=='On need basis' ){echo "selected" ;} ?>>On
                            need basis</option>
                        <option value="Yet to donate" <?php if($freq=='Yet to donate' ){echo "selected" ;} ?>>Yet to
                            donate</option>
                    </select>
                </div>
                <div class="col-12 mt-1">
            ...
            <div class='window'>
                ...
                <div class='content'>
                    <div class='input-fields'>
                        ...
                        Phone number: <input type="text" name="phno" value=""><br><br>
                        ...
                        Female <input type="radio" value="Female" name="gender" <?php if($gen=='Female' ){echo "checked"
                            ;} ?>>
                        Other <input type="radio" value="Other" name="gender" <?php if($gen=='Other' ){echo "checked" ;}
                            ?>><br><br>
